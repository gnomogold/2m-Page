...
export const CaptationFunnels: React.FC = () => {
  ...
  return (
    <section id="captation-funnels" className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white relative overflow-hidden">
      {/* Background Pattern */}
